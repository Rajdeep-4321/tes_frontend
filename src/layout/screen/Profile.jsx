  ...
  return (
    <>
        ...
        <table className="profile_table">
          <thead className="profile_thead">
            <tr className="profile_tr">
              ...
              <td>
                volume (24) <img src={tableicon} alt="" />
              </td>
              <td>
          ...
          <tbody className="profile_tbody" onClick={handleClickedButton}>
            {TableData.map((TableData) => (
              <tr key={TableData.rank}>
                ...
                <td>
                  <img src={profilemore} alt="" className="profilemore " />
                </td>
              </tr>
            ))}
          </tbody>
      ...
      <div className="profile_nextpage">
        <div>
          <p className="">Showing 10 from 160 data</p>
        </div>
        <div className="profile_nextpage_btn">
          <button className="profile_nextpage_btn_btn">
