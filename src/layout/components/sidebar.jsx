        ...
        <div className="sidebarmain">
                        <div className="sidenav">
                            <div className="navmenu">
                                <NavLink to="/dashboard"  className= {screenName == 'Dashboard' ? 'navitemSelected' : 'navitem'}>
                                ...
                                <NavLink to="/all-orders" className={screenName == 'All Orders' ? 'navitemSelected' : 'navitem'}>
                                ...
                                <NavLink to="/watchlist" className={screenName == 'Watch List' ? 'navitemSelected' : 'navitem'}>
                                ...
                                <NavLink to="/explore-market" className={screenName == 'Explore Market' ? 'navitemSelected' : 'navitem'}>
                                ...
                                <NavLink to="/portfolio" className={screenName == 'Portfolio' ? 'navitemSelected' : 'navitem'}>
